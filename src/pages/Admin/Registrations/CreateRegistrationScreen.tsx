...
export default function CreateRegistrationScreen({ route, navigation }: Props) {
    ...
    async function handleSave() {
        ...
        if (addInitialPayment && (!paymentAmount || !selectedPaymentMethodId || !selectedTreasurerId)) {
            Alert.alert('Atenção', 'Preencha os dados do pagamento inicial ou desative a opção.');
            return;
        }
